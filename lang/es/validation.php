...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'email' => [
            ...
            'verify' => 'Debe verificar su email (:email). :linkOpen Reenviar enlace :linkClose',
            'approved' => 'Debe activar su usuario para continuar. :linkOpen Activar aquí:linkClose'
        ]
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'address' => 'dirección',
        'gender' => 'género',
        'appointment_date' => 'fecha de consulta',
        'appointment_time' => 'hora de consulta',
        'consultation_type' => 'tipo de consulta',
        'specialty_id' => 'especialidad',
        'reason' => 'motivo',
        'patient_name' => 'nombre de paciente',
        'patient_birthdate' => 'fecha de nacimiento de paciente',
        'patient_address' => 'dirección de paciente',
        'patient_phone' => 'teléfono de paciente',
        'patient_gender' => 'género de paciente',
        ...
        'qr_location' => 'QR',
        'images.*' => 'imagenes',
        'is_pharmaceutical' => 'es farmaceutico',
